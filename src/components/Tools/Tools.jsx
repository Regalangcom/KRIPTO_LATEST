  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        ...
        {/* Card 2 */}
        <div className="card bg-gradient-to-r from-violet-600  to-green-500 text-white w-96 h-auto p-4 flex flex-row justify-between items-start transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/50 rounded-lg overflow-hidden">
        ...
        {/* Card 3 */}
        <div className="card bg-gradient-to-r from-orange-600  to-purple-700 text-white w-96 h-auto p-4 flex flex-row justify-between items-start transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/50 rounded-lg overflow-hidden">
          <div className="relative">
            {/* Badge */}
            <div className="badge absolute top-0  transform translate-x-2 -translate-y-2 bg-white text-black rounded-full py-2 px-4 text-xs">
              Beta
          ...
          <div className="card-body flex flex-col justify-between items-start ml-4 flex-grow h-full">
            <h2 className="card-title font-mono font-bold text-xl  mb-4">
              Privacy DEX
            </h2>
            <p className="font-mono  font-bold text-base mb-4 flex-grow overflow-hidden">
              {isReadMoreOpen[3]
        ...
        {/* Card 3 */}
        <div className="card bg-gradient-to-r from-green-600  to-orange-500 text-white w-96 h-auto p-4 flex flex-row justify-between items-start transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/50 rounded-lg overflow-hidden">
          <div className="relative">
            {/* Badge */}
            <div className="badge absolute top-0  transform translate-x-2 -translate-y-2 bg-white text-black rounded-full py-2 px-4 text-xs">
              Beta
        ...
        <div className="card bg-gradient-to-r from-violet-600  to-orange-500 text-white w-96 h-auto p-4 flex flex-row justify-between items-start transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/50 rounded-lg overflow-hidden">
          ...
          <div className="card-body flex flex-col justify-between items-start ml-4 flex-grow h-full">
            ...
            <p className="font-mono  font-bold text-base mb-4 flex-grow overflow-hidden">
              ...
              <span
                onClick={() => toggleReadMore(3)}
                className="text-black underline underline-offset-1 font-mono font-bold cursor-pointer ml-1"
              >
                {isReadMoreOpen[3] ? "Read less" : "Read more"}
              </span>
            </p>
