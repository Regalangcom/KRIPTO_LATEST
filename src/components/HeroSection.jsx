...
const HeroSection = () => {
  return (
    <div
      className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center px-6 lg:px-16 bg-[#18181A] text-white bg-no-repeat lg:bg-cover lg:bg-center"
      style={{
        backgroundImage: `url(${Auditor})`,
    ...
    >
      ...
      <motion.img
        src={logo}
        className="w-64 lg:w-80 max-w-full h-auto object-contain rounded-full shadow-lg m-4 lg:m-36"
        animate={{
          boxShadow: [
      ...
      >
        {/* Teks */}
        <h1 className="text-4xl font-mono lg:text-5xl font-bold mt-10 text-shadow-lg">
          Privacy.
        </h1>
        ...
        <motion.button
          className="mt-6 bg-violet-900 px-6 py-3 rounded-lg shadow-lg transition duration-300  mb-7 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-violet-500 focus:ring-opacity-50"
          whileHover={{
            boxShadow:
